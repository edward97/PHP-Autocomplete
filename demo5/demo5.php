...
<body>
    <div class="container">
        <h1>Dynamically Add & Remove Table Rows Using jQuery - #5</h1>
    ...
    <script>
        var smartAuto = (function() {
                ...
                currentEle.autocomplete({
                    source: function(data, callback) {
                        $.ajax({
                            url: "ajax.php",
                            method: "get",
                            data: { name: data.term, fieldNo: fieldNo },
                            dataType: "json",
                            success: function(res) {
                                ...
                                result = [
                                    {
                                        label: "There is no record found for: "+data.term,
                                        value: ""
                                    }
                                ];
                    ...
                    select: function(event, ui) {
                        ...
                        $("#countryname-"+rowNo).val(resArr[0]);
                        $("#countrynumber-"+rowNo).val(resArr[1]);
                        $("#countryphone-"+rowNo).val(resArr[2]);
                        $("#countrycode-"+rowNo).val(resArr[3]);
                    }
                });
            }
            ...
            function registerEvents() {
                ...
                // autocomplete
                $(document).on("focus", ".autocompletetxt", handleAutoComplete);
            }
